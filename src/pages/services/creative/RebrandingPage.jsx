...
export default function RebrandingPage({ onOpenContact, onBackHome }) {
  const [activeFaq, setActiveFaq] = useState(null);

  const deliverables = [
    "Professional Rebranding & Creative Illustration Services",
    "Leading Rebranding & Illustration Design Company Bangalore Vectors",
    "Illustration Agency Bangalore for Modern Brands Campaign Kits",
    "3D Illustration Design & Corporate Brand Identity Overhauls",
    "Complete Brand Guidelines & Vector Art Asset Package"
  ];
  ...
  const mainH2Sections = [
    {
      ...
      color: "#A068FF",
      desc: "Our creative illustration services help brands tell their stories better and engage their audience. We do this through high-quality custom artwork and digital designs.",
      bulletsHeader: "Points to consider:",
      bullets: [
    ...
    },
    {
      ...
      icon: Icons.Award,
      color: "#F5B800",
      desc: "Digiworq is a professional illustration design company in Bangalore. We focus on making visually appealing. Brand-focused illustration solutions for businesses across industries.",
      bulletsHeader: "Points to consider:",
      bullets: [
        "Customized illustration concepts",
        "Business-focused storytelling",
        "Creative digital artwork",
        "Modern illustration styles",
        "quality graphic solutions"
      ]
    },
    {
      ...
      icon: Icons.Sparkles,
      color: "#3B82F6",
      desc: "Our illustration agency in Bangalore delivers creative design solutions. These solutions improve branding, communication and customer engagement across print platforms.",
      bulletsHeader: "Points to consider:",
      bullets: [
    ...
    },
    {
      ...
      icon: Icons.Box,
      color: "#10B981",
      desc: "We offer professional 3D illustration design services. These services help businesses create immersive and engaging experiences for branding, presentations, architecture and marketing campaigns.",
      bulletsHeader: "Points to consider:",
      bullets: [
    ...
    },
    {
      ...
      color: "#EC4899",
      desc: "Digiworq combines creativity, branding expertise and modern design techniques. We deliver illustration services tailored for business growth.",
      bulletsHeader: "Points to consider:",
      bullets: [
    ...
    },
    {
      ...
      color: "#8B5CF6",
      desc: "We provide illustration design services for businesses across multiple industries and sectors.",
      bulletsHeader: "Points to consider:",
      bullets: [
        "Healthcare",
        "Education",
    ...
    },
    {
      ...
      color: "#F59E0B",
      desc: "Professional illustration design helps businesses communicate better visually and engage their customers.",
      bulletsHeader: "Points to consider:",
      bullets: [
  ...
  const rebrandingProcess = [
    {
      step: "01",
      title: "Research & Concept Development",
      desc: "We understand business goals, branding and illustration requirements."
    },
    {
      step: "02",
      title: "Creative Illustration Design",
      desc: "We create artwork and visual concepts aligned with brand identity."
    },
    {
      step: "03",
      title: "Final Delivery & Optimization",
      desc: "We deliver optimized illustration assets for print usage."
    }
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Illustrations help businesses create visual communication and improve customer engagement."
    },
    {
      q: "Do you provide custom illustration designs?",
      a: "Yes we create illustration solutions based on branding and marketing requirements."
    },
    {
      q: "Can illustrations be used for marketing?",
      a: "Yes illustrations are highly effective for websites, social media, advertising and content marketing."
    },
    {
      q: "Why choose Digiworq for illustration services in Bangalore?",
      a: "Digiworq delivers brand-focused and visually engaging illustration solutions, for modern businesses."
    }
  ];

  return (
    <div className="digiworq-service-page-root theme-rebranding">
      {/* Hero Section */}
      <section className="service-landing-hero hero-theme-rebranding" style={{ padding: '80px 0 50px 0', background: 'linear-gradient(180deg, #0A0E1A 0%, #0F172A 100%)', borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}>
        <div className="section-container">
          <div className="service-breadcrumbs" style={{ marginBottom: '20px' }}>
            ...
            <span className="bc-sep">&gt;</span>
            <span className="bc-current">Rebranding Services in Bangalore</span>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '40px', alignItems: 'center' }}>
            <div>
              <div className="eventura-badge-pill" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '6px 16px', background: 'rgba(160, 104, 255, 0.12)', border: '1px solid rgba(160, 104, 255, 0.3)', borderRadius: '30px', color: '#A068FF', fontSize: '0.85rem', fontWeight: '700', marginBottom: '20px' }}>
                <Icons.RefreshCw size={16} /> Rebranding & Visual Identity Transformation Studio
              </div>
              ...
              <div className="btn-border-wrap inline-block">
                <button className="marketeam-primary-btn" onClick={onOpenContact}>
                  <span>Book Rebranding Consultation</span>
            ...
            <div>
              <ServiceIllustrationCard serviceId="rebranding" title="Rebranding" />
            </div>
          </div>
          ...
          <div className="subservice-deliverables-banner" style={{ marginTop: '40px', background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '20px', padding: '24px' }}>
            <h3 style={{ color: '#FFFFFF', fontSize: '1.1rem', fontWeight: '800', marginBottom: '16px' }}>Rebranding & Illustration Deliverables:</h3>
      ...
      {/* Our Rebranding & Illustration Process Section */}
        ...
        <div className="section-container">
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            ...
            <p style={{ color: 'rgba(255, 255, 255, 0.75)', fontSize: '1.05rem', marginTop: '8px' }}>
              We follow a structured 3-phase creative process to research, sketch, design, and deliver brand artwork.
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
            {rebrandingProcess.map((stepItem, sIdx) => (
      ...
      <section style={{ padding: '60px 0 80px 0', background: '#05070F' }}>
        <div className="section-container text-center">
          <div className="services-cta-glass-box" style={{ background: 'linear-gradient(135deg, rgba(160, 104, 255, 0.1) 0%, rgba(15, 23, 42, 0.9) 100%)', border: '1px solid rgba(160, 104, 255, 0.3)', borderRadius: '24px', padding: '50px 30px' }}>
            <h2 style={{ fontSize: '2rem', fontWeight: '800', color: '#FFFFFF', marginBottom: '12px' }}>Ready to Transform Your Brand's Identity & Illustrations?</h2>
            <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '1.05rem', maxWidth: '650px', margin: '0 auto 24px auto' }}>Talk with Digiworq brand strategists and illustrators to reboot your visual presence.</p>
            <div className="btn-border-wrap inline-block">
              <button className="marketeam-primary-btn" onClick={onOpenContact}>
                <span>Book Rebranding Strategy Call</span>
                <Icons.ArrowRight size={18} />
              </button>
            </div>
          </div>
